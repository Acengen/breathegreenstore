...
<div class="text-right">
    <span class="estimateTxt">*Estimated total with tax &amp; shipping <a style="cursor:pointer;" id="myBtn">(?)</a></span>
					...
					<div class="kform_spacer">
						<input type="text" id="shippingAddress1" name="shippingAddress1" placeholder="Address Line 1" onFocus="geolocate()">
					</div>
					<div class="kform_spacer">
						<input type="text" id="shippingAddress2" name="shippingAddress2" placeholder="Address Line 2">
					</div>
					<div class="kform_spacer">
...
$( document ).ready(function() {
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBRrpNuCqkeH1NqSBP14wd0vPx7k6HL6t4&libraries=places&callback=initAutocomplete"
        async defer></script>
    <script>
