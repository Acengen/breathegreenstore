...
<div id="mainText1">
            ...
            <span style="font-size: 37px;"><span style="color: #ff9919; font-weight: bold;">WAIT!</span> Don't forget one for the Bathroom!</span>
            <br>To thank you for your purchase, we are giving you 1 EXTRA Breathe Green PURE for $39.95
						</div>
			<div id="breakLine"></div>
			<div id="innerMain">
				<div id="innerLeft">
					<div id="highlightImg" style="box-shadow: 1px 1px 5px rgba(68,68,68,0.5);">
						<img src="assets/images/up1a.jpg" width="100%">
					</div>
				</div>
<div id="innerRight">

                <div id="rightText1"> Get <b>an EXTRA Breathe Green PURE for your Bathroom</b> <!-- For Your Car (Just pay for shipping) --> </div>

                <div id="rightList">

                    <ul style="padding-left: 0px;">

                        <li>Helps purify the air in your room by bonding positively charged bacteria, germ and odor causing molecules and bonding them with healthy negatively charged ions.</li>

                        <li>Quickly reduces dust, allergens and pollutants in the air for better breathing.</li>

                        <li>Sleek &amp; Discrete - plugs directly into your outlet, quiet and no filter to be changed.</li>

                        <li>Works great, especially by places such as the dog's cage, garbage pail or even the baby's diaper pail.</li>

                        <li>Not harmful - safe to use around kids, pets and those who are sensitive to allergens.</li>
					...
					<form method="POST" action="inc/_upsell.php<?=$carry;?>" onsubmit="grayOut();">
						...
						<input type="submit" value="YES! I Want 1 EXTRA Breathe Green PURE!" class="kform_upsellBtn" id="kformSubmit" style="white-space: normal;">
					</form>
				</div>
				<div class="clear"></div>
			</div>
			<p class="no_thanks"><a href="<?=$nothanks;?>" onclick="grayOut();" id="no-thanks" class="textLink" style="font-size: 14px;">No thanks, I don't want an extra Purifier for my bathroom.</a></p>
		</div>
