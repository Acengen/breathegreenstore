		...
		<div class="row">
			<div class="col-lg-7 col-xl-8 px-xl-0">
				<h1 class="pt-3 pt-lg-0 mb-3">
					<b>Special Internet-Only Offer</b><br>on Breathe Green Charcoal Inserts</h1>
					<article class="d-none d-lg-block">
						<div class="d-flex">
							<div class="pr-4">
								<img src="images/charcoal-inserts.png" class="img-fluid" style="max-height:200px;">
								<p><b>More Than A Deodorizer</b> &ndash; Our air purifiers effectively reduce unwanted odors, allergens, pollutants, bacteria and prevents mold/mildew inside your shoes, sports equipment, car, purses, closets, drawers and much more.</p>
								<p><b>With Breathe Green</b> you can finally begin to fight off the tiny mold toxins that do the real damage to your healthy air. Normally these mycotoxins can stick around long after you’ve gotten rid of the mold. These charcoal bags could very well be the answer you’ve been looking for!</p>
								<ul class="list-unstyled">
									<li>Wicks &amp; Absorbs Moisture From The Air</li>
									<li>Helps Prevent Bacteria &amp; Mold Before They Stink Up Your Personal Items</li>
									<li>Maintains Your Shoes and keeps Your Car, Closets, Bathroom, Gym Bags, and much more) Fresh and Smelling Great!</li>
								</ul>
							</div>
						</div>
					</article>
			...
			<div class="col-lg-5 col-xl-4 d-none d-lg-block px-xl-0">
				<div class="package-selection pb-3">
					...
					<div class="package-selection__options">
						<form action="add-to-cart" method="post" id="package-selection-form">
							<input type="hidden" name="product" value="charcoal-inserts">
							<input type="hidden" name="regularly" id="regularly" value="200.00">
							<input type="hidden" name="displayname" value="Breathe Green Charcoal Inserts">
							...
							<button type="submit" class="d-flex align-items-center justify-content-center mx-auto add-to-cart-link" onclick="fbq('track', 'AddToCart', {content_name:'Charcoal Inserts'});">Add To Cart</button>
...
<main>
	...
	<div class="d-block d-lg-none">
		<center>
			<img src="images/charcoal-inserts.png" alt="" class="img-fluid d-block">
		</center>
		<div class="container">
		...
		<input type="hidden" name="package" value="5">
				...
				<span class="d-block package-selection__num-bottles">5 Inserts + 5 FREE</span>
		...
		<input type="hidden" name="package" value="3">
				<span class="d-block package-selection__num-bottles">3 Inserts + 2 FREE</span>
		...
		<input type="hidden" name="package" value="2">
				<span class="d-block package-selection__num-bottles">2 Inserts + 1 FREE</span>
	...
	<section class="faq my-4 py-4 d-none d-sm-block d-lg-none" id="faq">
        ...
        <div>
          <p class="font-weight-bold faq__q">Q: "How Many Pairs of Bags Do I Need For My Personal Items?"</p>
          <div>
            <p>You’ll need as many bags for as many items that you’d like to treat. The bags come in pairs because they are often used for items that come in pairs such as shoes, boots, sneakers, boxing gloves, hockey gloves and more. But you can also use just one of these smaller, thinner bags to fit more conveniently in items like your gym bags, luggage, suitcases, your car, yoga bag, dresser drawers, closet, etc. Place the Breathe Green Eco-Friendly Charcoal Bags anywhere you need to combat moisture, mold and bad smells.</p>
          </div>
        </div>
...
<div class="row">
	<div class="col-md-6 gartext">
		<p><strong>Guarantee #1:</strong> <u>The Quality</u> - Breathe Green Eco-Friendly Charcoal Bags are guaranteed to contain high-quality, Activated Porous Bamboo Charcoal, in the purest form possible, scientifically shown to absorb excess moisture from the air to help prevent against mold, mildew and bacteria, plus aid in reducing harmful chemicals including formaldehyde, ammonia, benzene and chloroform gases emitted from such items as paint, carpeting, air fresheners, chemical cleaners, rubber and plastic.</p>
