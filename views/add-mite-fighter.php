		...
		<div class="row">
			<div class="col-lg-7 col-xl-8 px-xl-0">
				<h1 class="pt-3 pt-lg-0 mb-3">
					<b>Special Internet-Only Offer</b><br>on Breathe Green Mite Fighters</h1>
					<article class="d-none d-lg-block">
						<div class="d-flex">
							<div class="pr-4">
								<img src="images/mite-fighter.png" class="img-fluid" style="max-height:200px;">
								<p><b>Live In A Clean House</b> &ndash; Our Mite Fighters effectively attack the dust mites that you already have in your home and help prevent new dust mite eggs from hatching!</p>
								<p><b>With Breathe Green</b> you can begin to fight off asthma, eczema, and allergies for respiratory and skin health, reduce acne, redness and itching, blocked or runny nose, sneezing, itchy or watery eyes, inflamed eyelids, shortness of breath, tight chest, coughing and wheezing. These Mite Fighter sachets could be the very answer you’ve been looking for!</p>
								<ul class="list-unstyled">
									<li>100% Safe To Use Throughout Your House</li>
									<li>Can Improve SLEEP And Overall Well-Being</li>
									<li>Within 72 Hours, You Can Start To See A Real Difference!</li>
								</ul>
							</div>
						</div>
					</article>
			...
			<div class="col-lg-5 col-xl-4 d-none d-lg-block px-xl-0">
				<div class="package-selection pb-3">
					...
					<div class="package-selection__options">
						<form action="add-mite-cart?<?=$GLOBALS['qs'];?>" method="post" id="package-selection-form">
							<input type="hidden" name="product" value="mite-fighter">
							<input type="hidden" name="regularly" id="regularly" value="200.00">
							<input type="hidden" name="displayname" value="Breathe Green Mite Fighter">
							...
							<div class="package-selection__subscribe py-2">
								<span class="d-block package-selection__details__big-price">
									<b>$<span id="big-price"></span><small><sup> /each pair</sup></small></b>
								</span>
								<span class="d-block package-selection__details__subtext">
									<b>+ <span class="free-number">5</span> FREE Pair<span id="plural">s</span></b><br>
									<b>+ FREE shipping</b>
								</span>
							</div>
							...
							<button type="submit" class="d-flex align-items-center justify-content-center mx-auto add-to-cart-link" onclick="fbq('track', 'AddToCart', {content_name:'Mite Fighter'});">Add To Cart</button>
...
<main>
	...
	<div class="d-block d-lg-none">
		<center>
			<img src="images/mite-fighter.png" alt="" class="img-fluid d-block">
		</center>
		<div class="container">
		...
		<input type="hidden" name="displayname" value="Breathe Green Mite Fighter">
				...
				<span class="d-block package-selection__num-bottles">5 + 5 FREE</span>
		...
		<input type="hidden" name="displayname" value="Breathe Green Mite Fighter">
				<span class="d-block package-selection__num-bottles">3 + 2 FREE</span>
		...
		<input type="hidden" name="displayname" value="Breathe Green Mite Fighter">
				<span class="d-block package-selection__num-bottles">2 + 1 FREE</span>
		...
		<div class="guarantee-mobile py-3">
			<div class="container">
				...
				<p>If you are not completely thrilled with your Breathe Green Charcoal Bag, we are offering you a 60-day guarantee on all purchases. Simply send the item(s) back to us for a full refund or replacement, less S&amp;H.</p>
			</div>
		</div>
	</div>
	<!-- /hidden on desktop -->
...
<div class="row">
	<div class="col-md-6 gartext">
		<p><strong>Guarantee #1:</strong> <u>The Quality</u> - Breathe Green Eco-Friendly Mite Fighter Sachets are guaranteed to contain high-quality citronella oil, lemon eucalyptus essence and mixed herbal extracts, all in their purest form possible with NO HARMFUL CHEMICALS scientifically proven to help prevent new dust mite eggs from hatching while affecting the ones already living in your home.</p>
		...
		<p><strong>Guarantee #3:</strong> <u>Your Complete Satisfaction</u> - Breathe Green stands behind each of our Mite Fighter Bags 100%. That's why you have a full 60 days to try our Mite Fighters and put them to the test yourself.</p>
	</div>
	<div class="col-md-6 text-center">
		<img src="images/60mbg.png" class="img-fluid float-left">
		<p class="p-1"><i>If you are not completely thrilled with your Breathe Green Mite Fighters, we are offering you a 60-day guarantee on all purchases. Simply send the item(s) back to us for a full refund or replacement, less S&amp;H.</i></p>
	</div>
</div>
</div>
</section>
