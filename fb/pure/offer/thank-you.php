...
<p><strong><u>IMPORTANT NOTE:</u> </strong> If you passed up on our offer for an extra Breathe Green PURE a moment ago OR you need MORE, then check this out. Our manufacturer just told us that we have one final shipment coming in with more purifiers and wanted you, as a new customer, to be the first to have the opportunity to get more. If you want <b>3 Additional Breathe Green PURE Air Deodorizers</b> at just $33.32 each ($99.95 Total)  <a style=" color: blue; text-decoration:underline;cursor: pointer;" onclick="submitpro();">Click here...</a> if not, continue below.</p>
...
<script>
  fbq('track', 'Purchase', {
    ...
    currency: 'USD',
			...
			<br><br>
			<p><strong>P.S.</strong> The offer above is limited to now only with this bit of extra inventory and and price-cut. Once this page is closed, it will not be shown again or offered anywhere else. If you want to get more and not risk us being sold out, click below!</p>
