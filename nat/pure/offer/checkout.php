...
<div class="natural">
            <h2 style="font-size: 20px; line-height: 26px; font-weight: bold;padding: 0 50px;">"Breathe deeper, live better and feel refreshed with Breathe Green PURE Air Ionizers!"</h2>
       		 ...
       		 <!-- <div class="phone-number"><p>Call 24/7: 1-888-415-1295</p></div> -->
			  <div class="about-container">
         <a class="button-look" onclick="javascript:openNewWindow('/offer/jc//contact.php','modal')" style="cursor:pointer">
			...
			<div id="checkoutSection">
				<div class="chk_section1">
					<div class="tm text-center">
						<p></p>
						<h4><b>The More PURE Air Purifiers You Buy, The Lower Your Cost Per Purifier!</b></h4>
						<p></p>
					</div>
...
<div class="col-md-6 col-sm-6 checkout-column" id="payinfo">
                ...
                <div class="row">
					<div class="banner">
                        <div class="sec_img" style="margin:0 auto; float:none;">
					  ...
					  <!-- <div class="col-md-8 col-sm-6 text-center banner__image marginCenter">
					   <span class="visible-xs visible-sm visible-md visible-lg">
						<img alt="" src="assets/images/logo-check.png">
					   </span>
					  </div> -->
					  <!-- <div class="col-md-4 col-sm-6 text-center banner__image marginCenter">
					   <span class="visible-xs visible-sm visible-md visible-lg">
						<img alt="" src="assets/images/product111a.png">
					   </span>
					  </div> -->
					  </div>
				</div>
				...
				<div class="col-xs-12 text-center center-block">
                    <img src="assets/images/guarantee-new.jpg" alt="">
					  <!-- <div class="trt-imgdiv">
						  <img src="assets/images/trt.png" alt="" class="img-responsive">
					  </div>trt-imgdiv 

					  <div class="trt-txtdiv">
						  <h3><font>90 DAY</font> MONEY BACK GUARANTEE <br>
							  <span>We will return you the money if you aren’t happy with your High Performance Breathe Green</span>
						  </h3>
		...
		<div id="recentBox">
			...
			<div id="recentText">
				...
				<br> purchased <br>
				<strong>Breathe Green PURE</strong>
				<br> About <span id="randTime">5</span> minutes ago 
			</div>
			<div class="clear"></div>
		</div>
		...
		<script type="text/javascript" src="assets/js/previous_buyers.js"></script>
		<script>
